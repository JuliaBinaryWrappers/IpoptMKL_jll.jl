...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import IpoptMKL_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6af6c270-9bc2-5f6c-a1c9-61e255f839ff"))
platforms = [Pkg.Artifacts.unpack_platform(e, "IpoptMKL", artifacts_toml) for e in artifacts["IpoptMKL"]]
...
if best_platform === nothing
    @debug("Unable to load IpoptMKL; unsupported platform $(triplet(platform_key_abi()))")
else
